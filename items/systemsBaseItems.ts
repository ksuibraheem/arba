...
export const SYSTEMS_BASE_ITEMS: BaseItem[] = [
    ...
    { id: "10.04", category: "mep_hvac", type: "all", name: { ar: "تشيلر مركزي (Chiller — وحدة تبريد)", en: "Central Chiller Unit", fr: "Groupe Froid Central (Chiller)", zh: "中央冷水机组" }, unit: "طن تبريد", qty: 0, baseMaterial: 1200, baseLabor: 200, waste: 0, suppliers: SUPPLIERS_HVAC, sbc: "SBC 501-Chiller", soilFactor: false, dependency: 'build_area' },
    ...
    { id: "15.05", category: "safety", type: "all", name: { ar: "شبكة رشاشات حريق (Sprinkler System)", en: "Fire Sprinkler System", fr: "Système Sprinkler Incendie", zh: "消防喷淋系统" }, unit: "م2", qty: 0, baseMaterial: 35, baseLabor: 15, waste: 0.05, suppliers: SUPPLIERS_FIRE_SAFETY, sbc: "SBC 901-Sprk", soilFactor: false, dependency: 'build_area' },
    ...
    { id: "20.04", category: "mep_hvac", type: "all", name: { ar: "شبكة مجاري الهواء (Ductwork)", en: "HVAC Ductwork Network", fr: "Réseau de Gaines", zh: "Ducts" }, unit: "م2", qty: 0, baseMaterial: 150, baseLabor: 50, waste: 0.1, suppliers: SUPPLIERS_HVAC, sbc: "SBC 501-DCT", soilFactor: false, dependency: 'build_area' },
