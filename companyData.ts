...
export const PAGE_TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    nav_support: { ar: 'الدعم', en: 'Support', fr: 'Assistance', zh: '支持' },
    nav_staff: { ar: 'الموظفين', en: 'Staff', fr: 'Personnel', zh: '员工' },
    about_title: { ar: 'من نحن', en: 'About Us', fr: 'À Propos', zh: '关于我们' },
    about_vision: { ar: 'الرؤية', en: 'Vision', fr: 'Vision', zh: '愿景' },
    about_mission: { ar: 'الرسالة', en: 'Mission', fr: 'Mission', zh: '使命' },
    about_values: { ar: 'قيمنا', en: 'Our Values', fr: 'Nos Valeurs', zh: '价值观' },
    payment_subtitle: { ar: 'اختر الخطة المناسبة لاحتياجاتك', en: 'Choose the plan that fits your needs', fr: 'Choisissez le forfait adapté', zh: '选择适合您的计划' },
    payment_projects: { ar: 'مشاريع', en: 'projects', fr: 'projets', zh: '项目' },
    per_project: { ar: 'لكل مشروع إضافي', en: 'per extra project', fr: 'par projet supplémentaire', zh: '每个额外项目' },
    warning: { ar: 'القيود', en: 'Limitations', fr: 'Limitations', zh: '限制' },
    encrypted_suppliers: { ar: 'أسماء الموردين مشفرة', en: 'Encrypted supplier names', fr: 'Noms fournisseurs cryptés', zh: '供应商名称已加密' },
    no_download: { ar: 'التنزيل غير متاح', en: 'Download not available', fr: 'Téléchargement indisponible', zh: '无法下载' },
    no_ai_pricing: { ar: 'بدون تسعير ذكي AI', en: 'No AI pricing', fr: 'Pas de tarification IA', zh: '无AI定价' },
    hero_demo: { ar: 'استعرض البرنامج', en: 'View Demo', fr: 'Voir la Démo', zh: '查看演示' },
    stat_support: { ar: 'دعم متواصل', en: '24/7 Support', fr: 'Assistance 24/7', zh: '全天候支持' },
    register_title: { ar: 'إنشاء حساب جديد', en: 'Create New Account', fr: 'Créer un Compte', zh: '创建新账户' },
    ...
    register_phone: { ar: 'رقم الجوال', en: 'Phone Number', fr: 'Téléphone', zh: '电话号码' },
    register_submit: { ar: 'إنشاء الحساب', en: 'Create Account', fr: 'Créer le Compte', zh: '创建账户' },
    register_have_account: { ar: 'لديك حساب؟', en: 'Have an account?', fr: 'Déjà un compte ?', zh: '已有账户？' },
    verification_title: { ar: 'التحقق من البريد', en: 'Email Verification', fr: 'Vérification E-mail', zh: '邮箱验证' },
    ...
    password_reset_title: { ar: 'استعادة كلمة المرور', en: 'Password Recovery', fr: 'Récupération Mot de Passe', zh: '密码恢复' },
    ...
    back_to_home: { ar: 'العودة للرئيسية', en: 'Back to Home', fr: 'Retour Accueil', zh: '返回首页' },
