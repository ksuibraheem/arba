...
export const PAGE_TRANSLATIONS = {
    ...
    verification_enter_code: { ar: 'اضغط على رابط التحقق المرسل إلى', en: 'Click the verification link sent to' },
    ...
    verification_invalid_code: { ar: 'لم يتم التحقق بعد', en: 'Not verified yet' },
