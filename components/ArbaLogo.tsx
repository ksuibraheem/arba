...
const ArbaLogo: React.FC<ArbaLogoProps> = ({ size = 40, animated = false, className = '' }) => {
    return (
        <svg
            ...
            style={{ display: 'block' }}
        >
            {/* الظل - خلف الحرف، مزاح لليمين والأسفل */}
            <g transform="translate(8, 8)" opacity="0.6">
                {/* الساق اليسرى */}
                <path d="M30,170 L30,165 Q30,160 33,155 L80,30 Q85,18 95,15 L105,15 Q115,18 120,30 L167,155 Q170,160 170,165 L170,170 L170,175 Q170,180 165,182 L155,182 Q148,182 145,175 L135,148 Q132,140 125,140 L75,140 Q68,140 65,148 L55,175 Q52,182 45,182 L35,182 Q30,180 30,175 Z" fill="#818CF8" />
                {/* سيريف يسار */}
                <rect x="18" y="170" width="48" height="14" rx="4" fill="#818CF8" />
                {/* سيريف يمين */}
                <rect x="135" y="170" width="48" height="14" rx="4" fill="#818CF8" />
                {/* سيريف أعلى */}
                <rect x="78" y="10" width="44" height="10" rx="3" fill="#818CF8" />
            </g>
