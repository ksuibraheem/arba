/**
 * ARBA Brain — Saudi Market Prices (يومي)
 * أسعار السوق السعودي — تحديث يومي
 *
 * المصادر:
 ...
 *
 * ⚠️ يتم تحديث الأسعار يومياً عبر الموردين والبورصة
 * ⚠️ يتم تطبيق معامل المدينة (locationMultiplier) تلقائياً
 * 📅 آخر تحديث: يتم تسجيله في PRICES_LAST_UPDATED
 */
