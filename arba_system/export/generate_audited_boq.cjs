...
const inputPath = path.join(__dirname, '..', 'training_data', 'pending', 'extracted_boq.json');
...
const summaryPath = path.join(__dirname, '..', 'training_data', 'pending', 'audit_summary.json');
