...
const outputPath = path.join(__dirname, '..', 'training_data', 'pending', 'extracted_boq.json');
fs.writeFileSync(outputPath, JSON.stringify(allItems, null, 2));
console.log(`Extracted ${allItems.length} valid items and saved to ${outputPath}.`);
